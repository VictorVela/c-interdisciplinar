...
namespace WebApplication2.Controllers
{
    ...
    public class ProfessoresController : Controller
    {
        ...
        public ProfessoresController(Data.ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NomeProfessor,SenhaProfessor,Cpf")] Professor professor)
        {
            if (id != professor.Id)
            {
                return NotFound();
